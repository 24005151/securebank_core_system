...
The test suite uses an in-memory SQLite database, a test-only API key, and has the rate limiter disabled to allow authentication tests to run without triggering the production rate limit.
